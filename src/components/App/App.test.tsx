...
describe('App', () => {
  describe('Board', () => {
    it('adds hit/miss mark correctly when clicking on the board', () => {
      render(<App />);

      userEvent.click(screen.getByTestId('board__cell-1-0'));
      userEvent.click(screen.getByTestId('board__cell-2-1'));
